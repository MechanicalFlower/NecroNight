...
func _movement(_delta) -> void:
	# Inputs
	input["left"] = int(input_wrapper.is_action_pressed("move_left"))
	input["right"] = int(input_wrapper.is_action_pressed("move_right"))
	input["foward"] = int(input_wrapper.is_action_pressed("move_forward"))
	input["back"] = int(input_wrapper.is_action_pressed("move_back"))
...
func _crouch(_delta) -> void:
	# Inputs
	input["crouch"] = int(input_wrapper.is_action_pressed("crounch"))
...
func _jump(_delta) -> void:
	# Inputs
	input["jump"] = int(input_wrapper.is_action_pressed("jump"))
...
func sprint(_delta) -> void:
	# Inputs
	# TODO : for controller make the sprint like a toggle button
	input["sprint"] = int(input_wrapper.is_action_pressed("sprint"))
